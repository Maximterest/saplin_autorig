...
def import_template (path = r'\\Storage01\3d4\seaOfLeaves\04_asset\character\bill\maya\scenes\edit\rig\utils\templates\bill_template_publish.ma'):
...
def spine_build (*args):
    ...
    for attr in ['x', 'y', 'z']:
        ...
        cmds.connectAttr(f'CTRL_ik_spine_04_C.s{attr}', f'H_SURF_for_SK_spine_07_C.s{dest}')
        cmds.connectAttr(f'CTRL_ik_spine_02_C.s{attr}', f'H_SURF_for_SK_spine_02_C.s{dest}')
...
def load_ctrlShape (path = r'\\Storage01\3d4\seaOfLeaves\04_asset\character\bill\maya\scenes\edit\rig\utils\shapes\bill_ctrlShapes.json'):
